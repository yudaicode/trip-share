...
export const metadata: Metadata = createMetadata({
  title: "プライバシーポリシー",
  description: "タビネタのプライバシーポリシーをご確認ください",
})
        ...
        <Card className="mb-6">
          <CardContent className="pt-6 prose prose-sm max-w-none">
            <p className="text-gray-600 mb-6">
              タビネタ（以下「当サービス」といいます。）は、本ウェブサイト上で提供するサービス（以下「本サービス」といいます。）における、
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">当サービスは、ユーザーが利用登録をする際に氏名、メールアドレスなどの個人情報をお尋ねすることがあります。</p>
              <p className="text-gray-700">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">当サービスが個人情報を収集・利用する目的は、以下のとおりです。</p>
            ...
            <section className="mb-8">
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700">
                <li>当サービスは、次に掲げる場合を除いて、あらかじめユーザーの同意を得ることなく、第三者に個人情報を提供することはありません。
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第9条（Cookie等の利用）</h2>
              <ol className="list-decimal list-inside space-y-2 text-gray-700">
                <li>当サービスは、ユーザーによる本サービスの利用状況を把握するため、Cookieを使用することがあります。</li>
                <li>Cookieとは、ウェブサーバがお客様のコンピューター端末を識別する業界標準の技術です。</li>
                <li>お客様がCookieの利用を希望されない場合、お客様ご自身でブラウザの設定を変更することによりCookieの利用を拒否することができます。ただし、Cookieの利用を拒否した場合、本サービスの一部の機能がご利用いただけなくなる場合があります。</li>
              </ol>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第10条（Google OAuth認証について）</h2>
              <ol className="list-decimal list-inside space-y-2 text-gray-700">
                <li>当サービスでは、ユーザーの利便性向上のため、Google OAuthによる認証機能を提供しています。</li>
                <li>Google OAuthを利用した場合、Googleアカウントの基本情報（メールアドレス、名前、プロフィール写真等）を取得いたします。</li>
                <li>取得した情報は、本ポリシー第3条に定める目的の範囲内でのみ利用し、それ以外の目的では利用いたしません。</li>
                <li>詳細については、Googleのプライバシーポリシーもあわせてご確認ください。</li>
              </ol>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第11条（Supabaseの利用について）</h2>
              <ol className="list-decimal list-inside space-y-2 text-gray-700">
                <li>当サービスは、データベースおよびストレージサービスとしてSupabaseを利用しています。</li>
                <li>Supabaseに保存される情報には、ユーザーが作成した旅行プラン、コメント、画像等が含まれます。</li>
                <li>Supabaseは適切なセキュリティ対策を実施しており、当サービスもこれに準じた対策を行っています。</li>
                <li>詳細については、Supabaseのプライバシーポリシーもあわせてご確認ください。</li>
              </ol>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第12条（プライバシーポリシーの変更）</h2>
              <ol className="list-decimal list-inside space-y-2 text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第13条（お問い合わせ窓口）</h2>
              <p className="text-gray-700 mb-4">本ポリシーに関するお問い合わせは、下記の窓口までお願いいたします。</p>
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-gray-700">
                  サービス名：タビネタ<br />
                  ウェブサイト：https://tabineta.vercel.app<br />
                  お問い合わせ：本サービスのお問い合わせフォームよりご連絡ください
                </p>
              </div>
            </section>
